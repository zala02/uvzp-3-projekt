...
class Model_Neural_Network(nn.Module):
    ...
    def __init__(self, input_len=48, input_dim=27, output_len=4, num_stations=84, lr=0.001, epochs=2000):
        super().__init__()
        ...
        self.model = nn.Sequential(
            nn.Flatten(),  # [batch_size, 48, 4] → [batch_size, 192]
    ...
    def forward(self, x):
        ...
        x = self.model(x)   # shape: [batch_size, 4 * 84]
