...
if __name__ == "__main__":
    ...
    for idx, station in enumerate(stations):
        ...
        print(f"timeseries sensor shape: {X_train_timeseries_tensor.shape}")
        print(f"attributes sensor shape: {X_train_attributes_tensor.shape}")
        print(f"y sensor shape: {y_train_tensor.shape}")
