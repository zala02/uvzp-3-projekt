...
class PrepareTimeSeries:
    ...
    def __init__(self, filename, train_size=48, predict_size=4, gap_size=10):
...
if __name__ == "__main__":
    ...
    station1 = stations[0]
    #print(f"were gonna predict only for station {station1}")

    # standardize data
    timeseries_class.standardize_data(station1)
    ...
    final_mae = nn.L1Loss()(y_pred, y_val_tensor).item()
